...
const Api_GetAll = "/api/api/v1/adminRoute/getAllCurriculum";
const Delete_API ="/api/api/v1/adminRoute/deleteCurriculum";
...
const Curriculum = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios
      .post("/api/api/v1/adminRoute/createCurriculum", formDataToSend, {
  ...
  useEffect(() => {
    axios.get("/api/api/v1/adminRoute/getAllCurriculum", {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  useEffect(() => {
    axios.get("/api/api/v1/adminRoute/getAllClass", {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  const handleDeleteCurriculum = (index) => {
    ...
    axios
      .delete("/api/api/v1/adminRoute/deleteCurriculum/" + curriculumId, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
