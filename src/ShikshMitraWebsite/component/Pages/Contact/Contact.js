...
const API_BASE_URL = "/api/api/v1/ContactUs";
const Contact = () => {
                  ...
                  <form onSubmit={handleSubmitCreate}>
                    <div className="mb-3">
                      <input
                        ...
                        name="name"
                        className="border-[f0f0f0] w-full rounded border py-3 px-[14px] text-base text-body-color outline-none 
                    ...
                    <div className="mb-3">
                      <textarea
                        ...
                        name="message"
                        className="border-[f0f0f0] w-full resize-none rounded border py-3 px-[14px] text-base text-body-color outline-none 
                    focus:border-primary focus-visible:shadow-none"
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full p-3 text-white bg-cyan-600  transition border rounded border-primary
