...
function CreateParents() {
  ...
  useEffect(() => {
    ...
    axios.get('https://average-red-kimono.cyclic.app/api/v1/adminRoute/getAllParents', 
    {
  ...
  const handleDelete = (email) => {
    axios.put(`https://average-red-kimono.cyclic.app/api/v1/adminRoute/deactivateParent`, {email}, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
