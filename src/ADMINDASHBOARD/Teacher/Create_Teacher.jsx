...
const modalStyle = {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://ebackend-iasf.onrender.com/api/v1/adminRoute/getTeachers', {
  ...
  const handleDelete = (email) => {
    axios.put(`https://ebackend-iasf.onrender.com/api/v1/adminRoute/deactivateTeacher`, { email }, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
