...
const Scheduler = () => {
    ...
    if (args.type === 'DeleteAlert') {
      ...
      if (args.event && args.event.target) {
        ...
        if (buttonText === 'delete') {
          ...
          // console.log(data)
            axios.delete(`https://ebackend-iasf.onrender.com/api/v1/events/deleteEvent/${data._id}`, 
          {
  ...
  useEffect(() => {
   const fetchData = async()=>{
    try {
      const response = await axios.get('https://ebackend-iasf.onrender.com/api/v1/events/getAllEvents', {
        withCredentials: true,
          headers: {
            Authorization: `Bearer ${authToken}`,
          },
  ...
  const onPopupClose = (args) => {
    ...
    if (args.type === 'Editor') {
      ...
      axios.post('https://ebackend-iasf.onrender.com/api/v1/events/createEvent', {
        updatedData
      }, {
        withCredentials: true,
      headers: {
